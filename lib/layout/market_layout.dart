...
import 'package:marketsystem/screens/credit/credit_screen.dart';
import 'package:marketsystem/screens/overview/overview_screen.dart';
                          ...
                          onTap: () async {
                            switch (_report_title.indexOf(element)) {
                              ...
                              case 1:
                                ...
                                Get.to(OverviewScreen(formattedDate));
                                break;
                              case 2:
